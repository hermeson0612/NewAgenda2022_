...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Stephany Maria</a>
        </div>
      </div>
              ...
              <div class="card-body p-0">
                <table class="table table-sm">
                  ...
                  <tbody>
                    ...
                    ?>
                    <tr>
                      <td><img style="width: 41px; border-radius: 100%;" src="img/<?php echo $show->fotoContato;?>"></td>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 - Todos os direitos reservados a</strong>
    Agenda JMF.
